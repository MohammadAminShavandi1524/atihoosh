...
export default function FooterContent() {
  ...
  return (
    <div className={cn("flex flex-col", isRtl && "text-right")}>
      {/* title */}
      <div className="s:text-[40px] s:mb-12 mb-10 text-[32px] font-medium xl:mb-22 2xl:mb-40 2xl:text-[48px]">
        {t("title")}
      </div>

      {/* links */}
      <div className="s:grid s:w-120 s:grid-cols-2 flex flex-col pe-4 text-xl xl:w-135 xl:text-[22px] 2xl:w-150 2xl:text-2xl">
        <div className="s:mb-0 s:gap-y-7 mb-6 flex flex-col gap-y-6 xl:gap-y-8">
        ...
        <div className="s:gap-y-7 flex flex-col gap-y-6 xl:gap-y-8">
      ...
      <div className="s:mt-15 mt-10 mb-7.5 flex items-center gap-x-3 xl:mt-20 xl:mb-10">
        ...
        <Link
          href="https://telegram.com/atihooshbonyanco"
          target="_blank"
