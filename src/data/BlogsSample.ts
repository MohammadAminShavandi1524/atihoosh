export const EN_latestBlogsSample: {
  indexNumber: string;
  title: string;
  tags: string[];
  description: string;
  ...
  {
    indexNumber: "02",
    title: "Behind Successful Software: From the First Idea to Final Delivery",
  ...
  {
    indexNumber: "03",
    title: "Cybersecurity: Is Your Company Ready for the Next Attack?",
  ...
  },
  {
    indexNumber: "04",
    title:
      "Digital Transformation: Why Do Some Companies Grow Faster Than Others?",
...
export const FA_latestBlogsSample: {
  indexNumber: string;
  title: string;
  tags: string[];
  description: string;
  ...
  {
    indexNumber: "01",
    title: "هوش مصنوعی در سال ۲۰۲۶؛ کدام کسب‌وکارها از رقابت عقب می‌مانند؟",
  ...
  {
    indexNumber: "02",
    title: "پشت صحنه ساخت یک نرم‌افزار موفق؛ از ایده تا اجرای نهایی",
  ...
  {
    indexNumber: "03",
    title: "امنیت سایبری؛ آیا شرکت شما برای حمله بعدی آماده است؟",
  ...
  {
    indexNumber: "04",
    title: "تحول دیجیتال؛ چرا برخی شرکت‌ها سریع‌تر از دیگران رشد می‌کنند؟",
